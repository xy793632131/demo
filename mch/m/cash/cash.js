...
Page({
    ...
    onShow: function() {
        ...
        getApp().core.showLoading({
            ...
            success: function(t) {
                if (0 == t.code) {
                    var a = {};
                    a.price = t.data.money, a.type_list = t.data.type_list, e.setData(a);
                }
            },
            complete: function(e) {
    ...
    formSubmit: function(e) {
        ...
        if (a) if (a > i) getApp().core.showToast({
            title: "提现金额不能超过" + i + "元",
            ...
            if (0 == o || 1 == o || 2 == o || 3 == o || 4 == o) {
                if ("my" == t.data.__platform && 0 == o && (o = 2), 1 == o || 2 == o || 3 == o) {
                    if (!(c = e.detail.value.name) || void 0 == c) return void getApp().core.showToast({
                        title: "姓名不能为空",
                        image: "/images/icon-warning.png"
                    });
                    if (!(s = e.detail.value.mobile) || void 0 == s) return void getApp().core.showToast({
                        title: "账号不能为空",
                        image: "/images/icon-warning.png"
                    });
                }
                if (3 == o) {
                    if (!(n = e.detail.value.bank_name) || void 0 == n) return void getApp().core.showToast({
                        title: "开户行不能为空",
                        image: "/images/icon-warning.png"
                    });
                } else n = "";
                if (4 == o || 0 == o) var n = "", s = "", c = "";
                getApp().core.showLoading({
                    title: "正在提交",
                    mask: !0
                }), getApp().request({
