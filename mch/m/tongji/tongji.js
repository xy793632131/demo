...
Page({
    ...
    changeMonth: function(t) {
        ...
        for (var n in a.data.year_list) {
            n == e ? (a.data.year_list[n].active = !0, a.data.current_year = a.data.year_list[n].year) : a.data.year_list[n].active = !1;
            for (var o in a.data.year_list[n].month_list) n == e && o == r ? (a.data.year_list[n].month_list[o].active = !0, 
