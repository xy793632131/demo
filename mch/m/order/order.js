...
Page({
    ...
    sendSubmit: function() {
        var t = this;
        if ("express" == t.data.send_type) return t.hideSendModal(), void getApp().core.navigateTo({
            url: "/mch/m/order-send/order-send?id=" + t.data.order_list[t.data.order_index].id
        });
        getApp().core.showModal({
            ...
            success: function(e) {
                e.confirm && (getApp().core.showLoading({
                    ...
                    data: {
                        send_type: "none",
                        order_id: t.data.order_list[t.data.order_index].id
                    },
                    success: function(t) {
                        getApp().core.showModal({
                            title: "提示",
