...
Page({
            ...
            getApp().request({
                ...
                success: function(t) {
                    if (0 == t.code) {
                        ...
                        o = 0 == i ? s % 60 + "秒" : i + "分" + s % 60 + "秒", !e && t.cha_time <= 300 ? a.setData({
                            buy: {
                                time: o,
                                type: t.data.type,
                                url: t.data.url,
    ...
    loadData: function(t) {
        var e = this, o = getApp().core.getStorageSync(getApp().const.PAGE_INDEX_INDEX);
        o && (o.act_modal_list = [], e.setData(o)), getApp().request({
            url: getApp().api.default.index,
            success: function(t) {
                0 == t.code && (a ? e.data.user_info_show || (a = !1) : t.data.act_modal_list = [], 
                e.setData(t.data), getApp().core.setStorageSync(getApp().const.PAGE_INDEX_INDEX, t.data), 
                e.miaoshaTimer());
            },
            complete: function() {
    ...
    onPullDownRefresh: function() {
        getApp().getStoreData(), clearInterval(e), this.loadData();
    },
